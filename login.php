...
<div class="login-box">
  ...
  <div class="card">
    ...
    <div class="d-flex justify-content-end" style="font-size:30px; "><a href="index.php"><i class="fa fa-times" aria-hidden="true"></i></a></div>
      <center><img width="150rem" src="assets/img/favicon.png"><br>
      <br><h4>Login</h4></center><br>
     <!--  <p class="login-box-msg">เข้าสู่ระบบ</p> -->

      <form action="chk_login.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" autocomplete=off name="mem_username" id="mem_username" placeholder="Username">
