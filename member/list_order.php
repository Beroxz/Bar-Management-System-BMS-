  ...
  <tbody>
    <?php foreach ($rs_my_order as $rs_order) { ?>
      ...
      <tr>
        ...
        <td>
          <a href="bill_order.php?order_id=<?php echo $rs_order['order_id']; ?>&act=view" class="btn btn-primary btn-xs"><i class="nav-icon fas fa-clipboard-list"></i> เปิดดูรายการ</a>
        </td>
