      ...
      <label for="" class="col-sm-2 col-form-label"></label>
          <div class="col-sm-5">
            <div class="row">
              ...
              <div class="col-6">
                <button type="button" class="btn btn-success btn-block " onclick="window.location='confirm_a_prompt.php?total=<?php echo ($total); ?>&act=promptpay';">QrCode-PromptPay</button>
              </div>
            </div>
          </div>
