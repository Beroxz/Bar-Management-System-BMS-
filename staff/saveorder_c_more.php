...
<?php
	...
	$pay_amount2 = 0;//ยอดเงินที่ต้องจ่าย
...
<script type="text/javascript">
	...
	window.location ='cart_detail.php?t_name=<?php echo $table_name;?>&order_id=<?php echo $order_id;?>&act=cart-detail';
</script>