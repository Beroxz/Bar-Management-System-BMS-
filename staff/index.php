                ...
                <div class="col-sm-12">
                  ...
                  <div class="row" style="margin-bottom: 20px;">
                    ...
                    if($row['table_status']==0){ //ว่าง
                        ...
                        echo '<a href="cart.php?t_name='.$row["table_name"].'" class="btn btn-success" style="padding: 1.5rem 3rem">'.$row['table_name'].'</a></div>';
                      // echo '<a href="cart.php?t_name='.$row["table_name"].'" class="btn btn-success" style="padding: 1.5rem 3rem">'.$row['table_name'].'</a></div>';
                      ...
                      echo '<a href="confirm_table_sale.php?id='.$row["table_id"].'&act=booking" class="btn btn-primary" style="padding: 1.5rem 3rem">'.$row['table_name'].'</a></div>';
                        ...
                        echo '<div class="col-2 col-md-2 col-sm-2" style="margin: 5px;">';
                      echo '<a href="cart_detail.php?table_id='.$row["table_id"].'&act=cart-detail" class="btn btn-warning" style="padding: 1.5rem 3rem">'.$row['table_name'].'</a></div>';
                        }
                      } ?>
                   </div>
                   </div>
