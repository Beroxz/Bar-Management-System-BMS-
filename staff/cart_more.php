...
<?php 
  ...
  $t_name = mysqli_real_escape_string($condb,$_GET['table_name']);
  $t_name = mysqli_real_escape_string($condb,$_GET['table_name']);
  $t_name = mysqli_real_escape_string($condb,$_GET['table_name']);
                                  ...
                                  <img width="100%" src="../p_img/<?php echo $rs_prd['p_img'] ;?>" class="card-img-top" alt="<?php echo $rs_prd['p_name'] ;?>" title="<?php echo $rs_prd['p_name'] ;?>">
                                    <div class="card-body">
                                      ...
                                      <p class="card-text"><?php echo number_format($rs_prd['p_price'],2); ?> Baht</p>
                                        ...
                                        <center>  
                                          <br>
                                          <a href="cart.php?t_name=<?php echo $t_name;?>&p_id=<?php echo $rs_prd['p_id'];?>&act=add" class="btn btn-success" target=""><i class="fa fa-shopping-cart"></i> หยิบลงตระกร้า</a>
                                        </center>
                                        <?php } else { ?>
